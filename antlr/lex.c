...
void GenRuleFuncRedefs( FILE *f, Junction *p )
{
 ...
 * globals.c.
 */
void GenPredefinedSymbolRedefs( FILE *f )
{
  char **p;
 ...
 * globals.c.
 */
void GenASTSymbolRedefs( FILE *f )
{
  char **p;
 ...
 */
void GenRulePrototypes( FILE *f, Junction *p )
{
  int i;
...
void DumpListOfParmNames(char *pdecl, FILE *output, int initialComma)    /* MR5 */
{
 ...
 */
void DumpOldStyleParms( char *pdecl, FILE *output )
{
...
void DumpRetValStruct( FILE *f, char *ret, int i )
{
  char *p = ret;
  char *pDataType;
  char *pSymbol;
